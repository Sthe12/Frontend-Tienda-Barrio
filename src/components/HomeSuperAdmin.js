                ...
                <div className='bg-dark col-auto col-md-2 min-vh-100 d-flex justify-content-between flex-column'>
                                ...
                                >
                                    ...
                                    <li className="nav-item">
                                        <a className="nav-link text-white fs-5" href="#" aria-current="page">
                                            <span className='d-none d-sm-inline bi bi-tags-fill'></span>
                    ...
                    <div className="dropdown open mt-5">
                        ...
                        >
                            ...
                            <span className='ms-2 d-none d-sm-inline'>SUPER-AMDIN</span>
                        </a>
